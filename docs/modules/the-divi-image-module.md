---
title: "The Divi Image Module"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/8637837-the-divi-image-module"
---
...
For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/8637837-the-divi-image-module).
...
| Image module |  | e moduleand click on it to load the module.The module library is also searchable. Type the module name you want in the search bar at the top. |

### Content Tab

| Setting | Type | Description |
|---------|------|-------------|
| Upload image |  | imagein the bottom right to select that image and add it to the module. |
| Open In Lightbox |  | Toggle this option toyesif you would like the image to open in a lightbox when clicked. When this option is on, the link options below will be unavailable. |
...
| Setting | Type | Description |
|---------|------|-------------|
| Image Alignment |  | Choose the alignment for the image:LeftCenterRight |
| Force Fullwidth |  | When enabled, this will force your image to extend 100% of the width of the column it's in. |
...
| Show Space Below Image |  | Be default, images have space below. Toggle this option tonoto remove the space. |
...
| Image Alternative Text |  | Image alt text is the text that is displayed if an image cannot be loaded. Adding image alt text helps with optimizing your website for search engines. |
| Image Title Text |  | If you'd like to add an image title to the image, type that here. |
