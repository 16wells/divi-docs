---
title: "The Divi Woo Product Stock Module"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/8675709-the-divi-woo-product-stock-module"
---
...
For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/8675709-the-divi-woo-product-stock-module).
...
| Woo Product Stock |  | roduct Stockmodule to add it to your page. |

### Content Tab

| Setting | Type | Description |
|---------|------|-------------|
| Product |  | This setting allows you to specify which product you want the module to relate to when it shows the product's stock number. By default, it's set toThis Product. For our purposes, we'll leave this setting set toThis Productso that it dynamically displays the correct stock number depending on what product is being viewed. |
...
| In Stock Font Style - |  | Choose the style of the in stock text font:ItalicizedCapitalizedSmall CapitalsUnderlinedStrike-through |
| In Stock Text Alignment - |  | Choose the text alignment specifically to the in stock text:LeftCenterRightJustify |
...
| In Stock Letter Spacing - |  | Choose the letter spacing of the in stock text by dragging the range slider or by typing in a numerical value. Letter spacing is the space between each letter. The higher the number, the more space. |
...
| In Stock Text Shadow - |  | Add a drop shadow to the in stock text. Once a style is selected, you can configure the direction of the shadow (horizontal and vertical), the strength of the drop shadow blur, and the shadow color. |
...
| Out Of Stock Font Style - |  | Choose the style of the out of stock text font:ItalicizedCapitalizedSmall CapitalsUnderlinedStrike-through |
| Out Of Stock Text Alignment - |  | Choose the text alignment specifically to the out of stock text only:LeftCenterRightJustify |
...
| Out Of Stock Letter Spacing - |  | Choose the letter spacing of the out of stock text by dragging the range slider or by typing in a numerical value. Letter spacing is the space between each letter. The higher the number, the more space. |
...
| Out Of Stock Text Shadow - |  | Add a drop shadow to the out of stock text. Once a style is selected, you can configure the direction of the shadow (horizontal and vertical), the strength of the drop shadow blur, and the shadow color. |
...
| On Backorder Font Style - |  | Choose the style of the on backorder text font:ItalicizedCapitalizedSmall CapitalsUnderlinedStrike-through |
| On Backorder Text Alignment - |  | Choose the text alignment specifically to the on backorder text:LeftCenterRightJustify |
...
| On Backorder Letter Spacing - |  | Choose the letter spacing of the on backorder text by dragging the range slider or by typing in a numerical value. Letter spacing is the space between each letter. The higher the number, the more space. |
...
| On Backorder Text Shadow - |  | Add a drop shadow to the on backorder text. Once a style is selected, you can configure the direction of the shadow (horizontal and vertical), the strength of the drop shadow blur, and the shadow color. |
...
| Woo Product Stock |  | ith all of our latest Divi Product Stock tutorials by checking out ourWoo Product Stockpage. |
