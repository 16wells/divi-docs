---
title: "The Divi Code Module"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/8608209-the-divi-code-module"
---
...
For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/8608209-the-divi-code-module).
...
|---------|------|-------------|
| Use The Divi Builder |  | ton underneath the page title that saysUse The Divi Builder. |
| Code module |  | e moduleand click on it to load the module.The module library is also searchable. Type the module name you want in the search bar at the top. |
...
| Module Link Target |  | Defining a link target determines whether the link, when clicked, opens in a new tab or in the same window. Choose one of the available options:In The Same Windowif you want the link to open in the same window.In The New Tab,if you would like that link to open in a new tab.By default,In The Same Windowis selected. |
| In The Same Window |  | if you want the link to open in the same window. |
| In The New Tab, |  | if you would like that link to open in a new tab.By default,In The Same Windowis selected. |
...
| + |  | lick the gray+icon to bring up the media library, where you can select an already uploaded photo from your library or upload a new one. |
| Mp4 vs WebM |  | We recommend uploading bothmp4version andwebmversion of the video because not all browsers support WebM video formats. Uploading both file types ensures your video will play on all devices and browsers. |
...
| Code |  | ultmarginvalues for theCodemodule are0. |
| Code |  | ultpaddingvalues for theCodemodule are as0: |
