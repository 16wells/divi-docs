---
title: "The Divi Fullwidth Portfolio Module"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/8637730-the-divi-fullwidth-portfolio-module"
---
...
For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/8637730-the-divi-fullwidth-portfolio-module).
...
| Setting | Type | Description |
|---------|------|-------------|
| Portfolio Title |  | If you want to display a portfolio title above the portfolio images, type the title here. |
...
| Show Date - |  | Toggle this option yes or no to show or hide the project date displayed by hovering over the project image. |
...
| Overlay Icon Color |  | Choose the color of the icon here. Select a color from the site palette or click the eyedropper icon to find a new color. To make the icon transparent, click the transparent circle on the right with the red slash through it. Doing so means the icon will not be visible, and only the overlay background color will show. |
| Overlay Background Color |  | Choose the color of the overlay background here. Select a color from the site palette or click the eyedropper icon to find a new color. If you want no overlay color to display, click the transparent circle on the right with the red slash. |
...
| Image Contrast - |  | You can adjust the image's contrast by dragging the range slider to input a numerical value in the textbox. |
...
| Portfolio Item Title Heading Level - |  | Choose the heading level assigned to this text: h1, h2, h3, h4, h5, or h6. |
| Portfolio Item Title Font - |  | Choose the font for the portfolio item title text. The default font is automatically selected; however, you can choose a different font or upload a custom font by clicking the dropdown box. |
| Portfolio Item Title Font Weight - |  | Click the dropdown to select the boldness of the portfolio item title text font. |
| Portfolio Item Title Font Style - |  | Defines the style of the portfolio item title text font:ItalicizedCapitalizedSmall capitalsUnderlinedStrike-through |
| Portfolio Item Portfolio Item Title Text Alignment - |  | Choose the text alignment specifically to the portfolio item title text only:LeftCenterRightJustify |
...
| Portfolio Item Title Letter Spacing - |  | Choose the letter spacing of the portfolio item title text by dragging the range slider or typing in a numerical value. Letter spacing is the space between each letter. The higher the number, the more space. |
...
| Portfolio Item Portfolio Item Title Text Shadow - |  | Here, you can add a drop shadow to the portfolio item title text. Once a style is selected, you can configure the direction of the shadow (horizontal and vertical), the strength of the drop shadow blur, and the shadow color. |
