---
title: "The Divi Text Module"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/8650241-the-divi-text-module"
---
...
For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/8650241-the-divi-text-module).
...
| Text module |  | t moduleand click on it to load the module.The module library is also searchable. Type the module name you want in the search bar at the top. |

### Content Tab

| Setting | Type | Description |
|---------|------|-------------|
| Body |  | Type your text here. You can use the formatting toolbar to style your text and find more text styling options under the Design tab. Click thetexttab if you’d like to edit the HTML of the text. |
