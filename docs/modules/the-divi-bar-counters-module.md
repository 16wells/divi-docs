---
title: "The Divi Bar Counters Module"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/8616758-the-divi-bar-counters-module"
---
...
For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/8616758-the-divi-bar-counters-module).
...
| Bar Counters module |  | s moduleand click on it to load the module.The module library is also searchable. Type the module name you want in the search bar at the top. |
| Add New Bar Counter |  | unter.Once clicked, the bar counter item will load, and you’ll see the Content, Design, and Advanced options for that specific bar counter item. |
| Title |  | the text you want displayed in theTitletext field and the number you want in thePercenttext field. |

### Content Tab

| Setting | Type | Description |
|---------|------|-------------|
| Show Percentage |  | Toggle this option toyesornoto show or hide the percent sign. If you choose to hide the percent sign, the number also is not visible. |
...
| + |  | lick the gray+icon to bring up the media library, where you can select an already uploaded photo from your library or upload a new one. |
| Mp4 vs WebM |  | We recommend uploading both an mp4 version and a.webmfile of the video because not all browsers support WebM video formats. Uploading both file types ensures your video will play on all devices and browsers. |
...
| Add Background Pattern |  | tternChoose the pattern type you want from the dropdown |
...
| Setting | Type | Description |
|---------|------|-------------|
| Bar Background Color |  | This controls the color of the bar counter. Select from your site’s color palette or click the eyedropper icon to find a new color. |
...
| Percentage Font - |  | Choose the font you want for the percentage text. The default font is automatically selected; however, you can choose a different font or upload a custom font by clicking the dropdown box. |
| Percentage Font Weight - |  | Click the dropdown to select the boldness of the percentage text font. |
| Percentage Font Style - |  | Choose the style of the percentage text font:ItalicizedCapitalizedSmall CapitalsUnderlinedStrike-through |
| Percentage Text Alignment - |  | Choose the text alignment specifically to the percentage text only:LeftCenterRightJustify |
| Percentage Text Color - |  | Choose a specific color for the percentage text. Select from your site’s color palette or click the eyedropper icon to find a new color. |
| Percentage Text Size - |  | Choose the font size of the percentage text by dragging the range slider or typing in a numerical value. |
| Percentage Letter Spacing - |  | Choose the letter spacing of the percentage text by dragging the range slider or by typing in a numerical value. Letter spacing is the space between each letter. The higher the number, the more space. |
| Percentage Line Height - |  | Choose the line height of the percentage text by dragging the range slider or by typing in a numerical value. The line height is the amount of space between each line of text. The higher the number, the more space. |
| Percentage Text Shadow - |  | You can add a drop shadow to the percentage text here. Once a style is selected, you can configure the direction of the shadow (horizontal and vertical), the strength of the drop shadow blur, and the shadow color. |
...
| Bar Counters |  | nvalues for theBar Countersmodule are0. |
| Bar Counters |  | ngvalues for theBar Countersmodule are0. |
