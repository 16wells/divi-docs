---
title: "The Divi Menu Module"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/9955331-the-divi-menu-module"
---
...
For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/9955331-the-divi-menu-module).
...
| Row |  | ck the Green iconto insert aRow. |
| Menu module |  | u moduleand click on it to load the module.The module library is also searchable. Type the module name you want in the search bar at the top. |
...
| Show Cart Quantity |  | Toggle this option toyesif you want to show the number of items currently added to the Shopping cart. |
...
| Add Background Color |  | Colorand select a color from your site's palette, or use the eyedropper icon to find a new color. |
...
| Cart Quantity Font Style |  | Choose the quantity's font styles:ItalicizedCapitalizedSmall CapitalsUnderlinedStrike-through. |
