---
title: "The Divi Divider Module"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/8637248-the-divi-divider-module"
---
...
For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/8637248-the-divi-divider-module).
...
| Divider module |  | r moduleand click on it to load the module.The module library is also searchable. Type the module name you want in the search bar at the top. |

### Content Tab

| Setting | Type | Description |
|---------|------|-------------|
| Show Divider |  | By default, this option is toggled toyeswhen the divider module is added. To hide the divider, toggle this option tono. |
...
| Setting | Type | Description |
|---------|------|-------------|
| Line Color |  | Choose a color of the line. Select from your site’s color palette or click the eyedropper icon to find a new color. |
| Line Style |  | Choose the style for the line: Solid, dashed, dotted, double, groove, ridge, inset, outset, or none. |
| Line Position |  | Choose the position of the line: top, vertically centered, or bottom. |
| Divider Weight |  | This is where you set the weight (thickness) of the divider. Type in a numerical value or drag the range slider to increase or decrease the line weight. |
