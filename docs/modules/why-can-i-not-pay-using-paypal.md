---
title: "Why can I not pay using PayPal?"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/2427363-why-can-i-not-pay-using-paypal"
---

# Why can I not pay using PayPal?

<!-- AUTO-CREATED: 2026-09-07 — stub from ET Help Center, needs enrichment -->

## Overview

For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/2427363-why-can-i-not-pay-using-paypal).
