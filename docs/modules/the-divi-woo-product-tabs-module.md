---
title: "The Divi Woo Product Tabs Module"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/8679277-the-divi-woo-product-tabs-module"
---
...
For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/8679277-the-divi-woo-product-tabs-module).
...
| Woo Product Tabs |  | Product Tabsmodule to add it to your page. |

### Content Tab

| Setting | Type | Description |
|---------|------|-------------|
| Product |  | This determines which product's details are displayed. Since we are using this module in a page template, we'll set this to "This Product" so that no matter what product page is being viewed, the specific product's details will be displayed. |
| Included Tabs |  | Choose what product information you want displayed in tabs - Description, Additional Information, and Reviews. Check or uncheck which ones you want to show or hide. |
...
| Tab Font Weight - |  | Select the boldness of the tab text font. |
| Tab Font Style - |  | Choose the style of the tab text font:ItalicizedCapitalizedSmall CapitalsUnderlinedStrike-through |
| Tab Text Alignment - |  | Choose the text alignment specifically to the tab textLeftCenterRightJustify |
