---
title: "The Divi Number Counter Module"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/8642911-the-divi-number-counter-module"
---
...
For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/8642911-the-divi-number-counter-module).
...
| Number Counter module |  | r moduleand click on it to load the module.The module library is also searchable. Type the module name you want in the search bar at the top. |

### Content Tab

| Setting | Type | Description |
|---------|------|-------------|
| Title - |  | Write the text you want to be displayed underneath the number here. |
| Number - |  | Write the number that you would like displayed here. Only numerical values are accepted. |
| Percent Sign - |  | If you want a percent sign displayed after the number, toggle this option toon. Toggle this option off if you want to display a number with no percent sign. |
...
| Module Link Target - |  | A link target means defining whether you want the link to open in a new tab or the same window when clicked.In The Same Window- if you want the link to open in the same windowIn The New Tab- if you want that link to open in a new tab. |
...
| Number Font - |  | Choose the font you want to use for the number. The default font is automatically selected. However, you can choose a different font or upload a custom font by clicking the dropdown box. |
| Number Font Weight - |  | Click the dropdown to select the boldness of the number font. |
| Number Font Style - |  | Choose the number font style:ItalicizedCapitalizedSmall CapitalsUnderlinedStrike-through |
| Number Text Alignment - |  | Choose the number text alignment:LeftCenterRightJustify |
| Number Text Color - |  | Choose a specific color for the number font. Select from your site's color palette or click the eyedropper icon to find a new color. |
| Number Text Size - |  | Choose the font size for the number font by dragging the range slider or typing in a numerical value. |
| Number Letter Spacing - |  | Choose the letter spacing of the number font by dragging the range slider or typing in a numerical value. Letter spacing is the space between each letter. The higher the number, the more space. |
...
| Number Text Shadow - |  | You can add a drop shadow to the number here. Once a style is selected, you can configure the direction of the shadow (horizontal and vertical lengths), the strength of the drop shadow blur, and the shadow color. |
