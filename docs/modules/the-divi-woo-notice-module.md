---
title: "The Divi Woo Notice Module"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/8680481-the-divi-woo-notice-module"
---

# The Divi Woo Notice Module

<!-- AUTO-CREATED: 2026-09-07 — stub from ET Help Center, needs enrichment -->

## Overview

For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/8680481-the-divi-woo-notice-module).
...
| Woo Notice |  | heWoo Noticemodule to add it to your page. |

### Content Tab

| Setting | Type | Description |
|---------|------|-------------|
| Page Type |  | Select the type of page you are putting this module on:Product pageCart pageCheckout page. |
| Product |  | This setting allows you to specify which product you want the module to relate to when it displays the notice message. By default, it’s set toThis Product. For our purposes, we’ll leave this setting set to This Productso that it dynamically displays the title of the product that was added to the cart. |
...
| Error Font |  | Choose the font you want to use for the error text. The default font is automatically selected; however, you can choose a different font or upload a custom font by clicking the dropdown box. |
| Error Font Weight |  | Click the dropdown to select the boldness of the error text font. |
| Error Font Style |  | Choose the style of the error text font:ItalicizedCapitalizedSmall CapitalsUnderlinedStrike-through |
| Error Text Alignment |  | Choose the text alignment specifically to the error text only:LeftCenterRightJustify |
| Error Text Color |  | Choose a specific color for the error text. Select from your site’s color palette or click the eyedropper icon to find a new color. |
| Error Text Size |  | Choose the font size of the error text by dragging the range slider or typing in a numerical value. |
| Error Letter Spacing |  | Choose the letter spacing of the error text by dragging the range slider or by typing in a numerical value. Letter spacing is the space between each letter. The higher the number, the more space. |
| Error Line Height |  | Choose the line height of the error text by dragging the range slider or by typing in a numerical value. The line height is the amount of space between each line of text. The higher the number, the more space. |
| Error Text Shadow |  | Add a drop shadow to the error text. Once a style is selected, you can configure the direction of the shadow (horizontal and vertical), the strength of the drop shadow blur, and the shadow color. |
...
| Body Font Weight |  | Choose the boldness of the body text font. |
