---
title: "The Divi Fullwidth Slider Module"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/8650073-the-divi-fullwidth-slider-module"
---
...
For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/8650073-the-divi-fullwidth-slider-module).
...
| + |  | lick the+icon to add a section and |
| Fullwidth |  | Fullwidthtab to add a fullwidth section. |
| Fullwidth Slider |  | th Sliderand click to load the module. |
...
| Setting | Type | Description |
|---------|------|-------------|
| Use Background Overlay |  | Toggle this yes or no to display an overlay over the background of this module. |
...
| Text Overlay Border Radius |  | A border radius rounds corners. If you'd like to apply rounded corners, increase the border-radius by typing in a numerical value or dragging the range slider. |
...
| Image Border Color - |  | Set the border's color. You can select a color from your default site color palette that is already displayed or click on the eyedropper icon to find a new color. |
...
| Button |  | Type the button text here. If you don’t want a button to appear, leave this field blank. |
| Body |  | Type the body text here. Leave this field blank if you don’t want any text to appear. |
| Image |  | Click theAdd Imagebutton to bring up your site’s media library, where you can select a photo or upload a new one. |
| Video |  | Click theAdd Videobutton to bring up your site’s media library, where you can select a video or upload a new one. |
| Button Link URL |  | Paste the URL you want to apply to the button here. When clicked, visitors will be taken to that web link. |
| Button Link Target |  | Defining a link target determines whether the link, when clicked, opens in a new tab or the same window.In The Same Window- if you want the link to open in the same windowIn The New Tab- if you want that link to open in a new tab. |
| In The Same Window |  | if you want the link to open in the same window |
| In The New Tab |  | if you want that link to open in a new tab. |
| Module Link URL |  | Paste the URL of the link you would like to apply to this module here. This makes the entire module clickable, and when clicked, it will direct visitors to the URL pasted here. |
| Module Link Target |  | Defining a link target determines whether the link, when clicked, opens in a new tab or the same window.In The Same Window- if you want the link to open in the same windowIn The New Tab- if you want that link to open in a new tab. |
