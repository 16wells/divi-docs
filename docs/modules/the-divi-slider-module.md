---
title: "The Divi Slider Module"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/8650071-the-divi-slider-module"
---
...
For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/8650071-the-divi-slider-module).
...
| Slider module |  | r moduleand click on it to load the module.The module library is also searchable. Type the module name you want in the search bar at the top. |

### Content Tab

| Setting | Type | Description |
|---------|------|-------------|
| + |  | lick the+icon aboveAdd New Slide. |
| Show Arrows |  | Toggle this option to yes or no to show or hide the navigational arrows on the slider. |
| Show Controls |  | Toggle this option toyesornoto show or hide the controls at the bottom of the slider (the dot navigation). |
...
| Image |  | To add an image, clickAdd Image,which will bring up your site’s media library, where you can select a photo or upload a new one. |
| Video |  | To add a video, clickAdd Video,which will bring up your site’s media library, where you can select a video or upload a new one. |
