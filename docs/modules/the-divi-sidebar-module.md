---
title: "The Divi Sidebar Module"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/8650069-the-divi-sidebar-module"
---
...
For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/8650069-the-divi-sidebar-module).
...
| Sidebar module |  | theSidebar moduleand click to load the module. |

### Content Tab

| Setting | Type | Description |
|---------|------|-------------|
| Widget Area |  | Click the dropdown to select the widget you want to use. For our purposes, we'll select Sidebar. |
...
| Show Border Separator |  | Toggle this option yes or no to show or hide the border separator. |
