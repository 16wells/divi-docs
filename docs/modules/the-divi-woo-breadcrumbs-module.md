---
title: "The Divi Woo Breadcrumbs Module"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/8679275-the-divi-woo-breadcrumbs-module"
---

# The Divi Woo Breadcrumbs Module

<!-- AUTO-CREATED: 2026-09-07 — stub from ET Help Center, needs enrichment -->

## Overview

For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/8679275-the-divi-woo-breadcrumbs-module).
...
| Woo Breadcrumbs |  | Breadcrumbsmodule to add it to your page. |

### Content Tab

| Setting | Type | Description |
|---------|------|-------------|
| Product |  | Select which product the breadcrumb will be related to. By default, it's set to This Product, which is the product that is currently viewed. |
| Home Text |  | Specify what text should be displayed as the first item in the Breadcrumb module. By default, the text will be Home. |
| Home Link |  | Define the link for the first item in the Breadcrumbs. Using / will always link back to the homepage. |
| Separator |  | Select the Separator you'd like between each Breadcrumb Item. The default Separator is/. However, you can use>,-,➝Other suitable symbols. |
