---
title: "The Divi Circle Counter Module"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/8617719-the-divi-circle-counter-module"
---
...
For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/8617719-the-divi-circle-counter-module).
...
| Circle Counter module |  | r moduleand click on it to load the module.The module library is also searchable. Type the module name you want in the search bar at the top. |

### Content Tab

| Setting | Type | Description |
|---------|------|-------------|
| Title |  | Type the title that is displayed beneath the circle counter here. |
| Number |  | Type the number that the circle counter will count to here. |
| Percent Sign |  | Toggle this option toyesornoto show or hide the percent sign. |
...
| + |  | lick the gray+sign to bring up the Media Library, where you can select an already uploaded photo from your library or upload a new one. |
...
| + |  | lick the gray+sign to bring up the media library, where you can select an already uploaded photo from your library or upload a new one. |
| Mp4 vs WebM |  | We recommend uploading both an mp4 version and.webmversion of the video because not all browsers support WebM video formats. Uploading both file types ensures your video will play on all devices and browsers. |
...
| pattern |  | he 5th tab, thepatterntab |
| Add background pattern |  | ound patternbutton |
...
| Setting | Type | Description |
|---------|------|-------------|
| Circle Color |  | Choose the fill color for the animated line in the circle counter. Select from your site’s color palette or click the eyedropper icon to find a new color. |
| Circle Background Color |  | Pick a color for the remaining circle. Select from your site’s color palette or click the eyedropper icon to find a new color. |
| Circle Background Opacity |  | Adjust the opacity (transparency) of the circle background color. The higher the number, the less transparent it will be. |
...
| Title Font Style - |  | Choose the style of the title text font:Italicized,Capitalized,Small Capitals,Underlined, orStrike-through. |
| Title Text Alignment - |  | Choose the text alignment specifically to the title text only:Left,Center,Right, orJustify. |
...
| Number Font - |  | Choose the font you want to use for the number text. The default font is automatically selected; however, you can choose a different font or upload a custom font by clicking the dropdown box. |
| Number Font Weight - |  | Click the dropdown to select the boldness of the number text font. |
| Number Font Style - |  | Choose the style of the number text font:Italicized,Capitalized,Small Capitals,Underlined, orStrike-through. |
| Number Text Alignment - |  | Choose the text alignment specifically to the number text only:Left,Center,Right, orJustify. |
| Number Text Color - |  | Choose a specific color for the number text. Select from your site’s color palette or click the eyedropper icon to find a new color. |
| Number Text Size - |  | Choose the font size of the number text by dragging the range slider or typing in a numerical value. |
| Number Letter Spacing - |  | Choose the letter spacing of the number text by dragging the range slider or by typing in a numerical value. Letter spacing is the space between each letter. The higher the number, the more space. |
| Number Line Height - |  | Choose the line height of the number text by dragging the range slider or by typing in a numerical value. The line height is the amount of space between each line of text. The higher the number, the more space. |
| Number Text Shadow - |  | Here, you can add a drop shadow to the number text. Once a style is selected, you can configure the direction of the shadow (horizontal and vertical), the strength of the drop shadow blur, and the shadow color. |
...
| Circle Counters |  | lues for theCircle Countersmodule are0. |
| Circle Counters |  | alues for theCircle Countersmodule are as0: |
