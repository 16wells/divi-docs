---
title: "The Divi Post Navigation Module"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/8643125-the-divi-post-navigation-module"
---
...
For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/8643125-the-divi-post-navigation-module).
...
| All Posts |  | to your blog post template (you'll know it's the blog post template because it saysAll Postsin the description). |
| Custom Body |  | encil icon next toCustom Bodyto edit the body portion of that page template. This will load the page template with the drag-and-drop Divi Visual Builder interface, where we can begin styling the post-navigation module. |
| + |  | lick the gray+icon to load the module library. |
| Post Navigation |  | ost Navigationand click to load the module. |

### Content Tab

| Setting | Type | Description |
|---------|------|-------------|
| Previous Link |  | Type the text you'd like the previous link to display here. Example:PrevorPrevious, etc. If this is left blank, the default text displayed is the title of the previous blog post or project. |
...
| Navigate Within Current Category |  | Toggle this option toyesif you want the previous and next links to navigate only within the same category as the current post or project.Leave this set tonoif you want the previous and next links to navigate through the posts or projects chronologically. |
| yes |  | gle this option toyesif you want the previous and next links to navigate only within the same category as the current post or project. |
| no |  | ave this set tonoif you want the previous and next links to navigate through the posts or projects chronologically. |
| yes |  | Custom Taxonomy Name field appears when this option is toggled toyes. If you use this module on a post or project, leave this textbox blank. Otherwise, type the taxonomy name in the textbox to make theIn The Same Categoryoption work correctly. |
| Show Previous Post Link |  | Toggle this option,yesorno,to show or hide the previous post link. |
| Show Next Post Link |  | Toggle this option,yesorno,to show or hide the next post link. |
...
| Links Font Style |  | Choose the style of the links text font:ItalicizedCapitalizedSmall CapitalsUnderlinedStrike-through |
