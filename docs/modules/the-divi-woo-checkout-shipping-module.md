---
title: "The Divi Woo Checkout Shipping Module"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/8679269-the-divi-woo-checkout-shipping-module"
---
...
For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/8679269-the-divi-woo-checkout-shipping-module).
...
| Woo Checkout Shipping |  | out Shippingmodule to add it to your page. |
...
| Setting | Type | Description |
|---------|------|-------------|
| Default |  | Display all the form fields in a fullwidth layout. |
| Fullwidth |  | Display all the form fields in a fullwidth layout. |
| 2 Column |  | Display all the form fields in a 2 column layout. |
...
| Field Letter Spacing - |  | Choose the letter spacing of the field's text by dragging the range slider or by typing in a numerical value. Letter spacing is the space between each letter. The higher the number, the more space. |
...
| Fields Border Styles |  | Add a border to the fields. You can add a border to all sides of the image or individual sides (top, right, bottom, and left). |
