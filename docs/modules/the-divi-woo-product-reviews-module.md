---
title: "The Divi Woo Product Reviews Module"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/8676111-the-divi-woo-product-reviews-module"
---
...
For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/8676111-the-divi-woo-product-reviews-module).
...
| Woo Product Reviews |  | duct Reviewsmodule to add it to your page. |

### Content Tab

| Setting | Type | Description |
|---------|------|-------------|
| Product |  | This setting allows you to specify which product you want the module to relate to when it shows product reviews. By default, it's set toThis Product. For our purposes, we'll leave this setting set toThis Productso that the module dynamically displays product views based on the currently viewed product. |
| Show Author Avatar |  | Toggle this option toyesornoto show or hide the author avatar (the profile pic image). |
| Show Comment Count |  | Toggle this option toyesornoto show or hide the comment count. |
| Show Meta |  | Toggle this option toyesornoto show or hide the meta text. |
| Show Rating |  | Toggle this option toyesornoto show or hide the product rating in each comment. |
...
| Fields Focus Background Color |  | Choose a background color for typed fields. For example, you could have the background color change when a visitor clicks on that field and starts typing. Select from your site’s color palette or click the eyedropper icon to find a new color. |
...
| Fields Border Styles |  | Add a border to the fields. You can add a border to all sides of the image or to individual sides (top, right, bottom, and left). |
...
| Use Focus Borders |  | Toggle this option toyesif you'd like to add a border to fields in focus. |
...
| Image Border Width - |  | Choose the width of the border. For a thicker border, increase the number. The border width must be at least 1px to show. |
...
| Image Blend Mode - |  | The Blend Mode refers to how the module blends with the layers beneath it. By default,normalwill be selected. |
| Text Alignment - |  | Cchoose how the text aligns:LeftCenterRightJustify |
...
| Review Count Heading Level - |  | Choose the heading level assigned to the review count text: h1, h2, h4, h4, h5, or h6. |
...
| Review Count Font Weight - |  | Select the boldness of the review count text font. |
| Review Count Font Style - |  | Choose the style of the review count text font:ItalicizedCapitalizedSmall CapitalsUnderlinedStrike-through |
| Review Count Text Alignment - |  | Choose the text alignment specifically to the review count text:LeftCenterRightJustify |
...
| Review Count Letter Spacing - |  | Choose the letter spacing of the review count text by dragging the range slider or by typing in a numerical value. Letter spacing is the space between each letter. The higher the number, the more space. |
...
| Review Count Text Shadow - |  | Add a drop shadow to the review count text. Once a style is selected, you can configure the direction of the shadow (horizontal and vertical), the strength of the drop shadow blur, and the shadow color. |
...
| Form Title Font Weight - |  | Select the boldness of the form title text font. |
| Form Title Font Style - |  | Choose the style of the form title text font:ItalicizedCapitalizedSmall CapitalsUnderlinedStrike-through |
| Form Title Text Alignment - |  | Choose the text alignment to the form title text:LeftCenterRightJustify |
...
| Form Title Text Shadow - |  | Add a drop shadow to the form title text. Once a style is selected, you can configure the direction of the shadow (horizontal and vertical), the strength of the drop shadow blur, and the shadow color. |
...
| Meta Font Weight - |  | Select the boldness of the meta text font. |
...
| Meta Text Shadow - |  | Add a drop shadow to the meta text. Once a style is selected, you can configure the direction of the shadow (horizontal and vertical), the strength of the drop shadow blur, and the shadow color. |
...
| Comment Font Style - |  | Choose the style of the comment text font:ItalicizedCapitalizedSmall CapitalsUnderlinedStrike-through |
| Comment Text Alignment - |  | Choose the text alignment specifically to the comment text:LeftCenterRightJustify |
...
| Comment Text Shadow - |  | Add a drop shadow to the comment text. Once a style is selected, you can configure the direction of the shadow (horizontal and vertical), the strength of the drop shadow blur, and the shadow color. |
| Star Rating Alignment |  | This allows you to choose how the star rating aligns:LeftCenterRightJustify |
...
| Button Alignment |  | Choose how the button aligns:LeftCenterRightJustify |
