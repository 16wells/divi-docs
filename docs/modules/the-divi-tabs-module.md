---
title: "The Divi Tabs Module"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/8650239-the-divi-tabs-module"
---
...
For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/8650239-the-divi-tabs-module).
...
|---------|------|-------------|
| purple button |  | le buttonunderneath the page title.Use The Divi Builder. |
| Tabs module |  | s moduleand click on it to load the module.The module library is also searchable. Type the module name you want in the search bar at the top. |

### Content Tab

| Setting | Type | Description |
|---------|------|-------------|
| + |  | lick the grey+icon labeledAdd New Tab. |
| Title |  | Write the title of the tab here. |
| Body |  | Write the tab content here. |
...
| Active Tab Background Color |  | Choose the background color of the active tab (the tab currently being viewed) here. Choose a color from your site's color palette or select a new one by clicking the eyedropper icon. |
| Inactive Tab Background Color |  | Choose the background color of the inactive tabs here. Choose a color from your site's color palette or select a new one by clicking the eyedropper icon. |
| Active Tab Text Color |  | Choose the text color of the active tab (the tab currently being viewed) here. Choose a color from your site's color palette or select a new one by clicking the eyedropper icon. |
| Tab Text Color |  | Choose the tab text color here. Choose a color from your site's color palette or select a new one by clicking the eyedropper icon. |
| Tab Font - |  | Choose the font you want for the tab text. The default font is automatically selected; however, you can choose a different font or upload a custom font by clicking the dropdown box. |
| Tab Font Weight - |  | Click the dropdown to select the boldness of the tab text font. |
| Tab Font Style - |  | Choose the style of the tab text font:ItalicizedCapitalizedSmall CapitalsUnderlinedStrike-through |
| Tab Text Alignment - |  | Choose the text alignment specifically to the tab text only:LeftCenterRightJustify |
...
| Tab Letter Spacing - |  | Choose the letter spacing of the tab text by dragging the range slider or by typing in a numerical value. Letter spacing is the space between each letter. The higher the number, the more space. |
...
| Tab Text Shadow - |  | Add a drop shadow to the tab text. Once a style is selected, you can configure the direction of the shadow (horizontal and vertical), the strength of the drop shadow blur, and the shadow color. |
