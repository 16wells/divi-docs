---
title: "The Divi Fullwidth Map Module"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/8637565-the-divi-fullwidth-map-module"
---
...
For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/8637565-the-divi-fullwidth-map-module).
...
| Fullwidth Map module |  | p moduleand click on it to load the module.The module library is also searchable. Type the module name you want in the search bar at the top. |
...
| Body |  | This is where you can type any text you want to be displayed when the pin is clicked. For example, you could put a description of this location, contact info for this location, etc. |
| Map |  | To add an address to this pin, click on the Map toggle and paste the pin address in the field box, then clickFindto orient the pin to that address. |
| Google API Key |  | To add your Google API Key, click the buttonChange API Key,which will open up a tab to the Divi Theme Options, where you can paste the API key in the Google API Key field. |
| Map Center Address |  | Put the address you want to be the center focal point for the map here and then clickFindto orient the map to that address. |
...
| Setting | Type | Description |
|---------|------|-------------|
| Mouse Wheel Zoom |  | Toggle this option toyesif you want the map's zoom level controlled by the mouse wheel, or toggle it tonoto disable this mouse wheel zoom functionality. |
| Draggable On Mobile |  | Toggle this option toyesornoif you want the map to be draggable or not on mobile. |
