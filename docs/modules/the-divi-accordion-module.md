---
title: "The Divi Accordion Module"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/8611169-the-divi-accordion-module"
---
...
For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/8611169-the-divi-accordion-module).
...
| Accordion module |  | n moduleand click on it to load the module.The module library is also searchable. Type the module name you want in the search bar at the top. |

### Content Tab

| Setting | Type | Description |
|---------|------|-------------|
| Icon |  | choose the icon to be used when the Accordion item is in close state. |
...
| Setting | Type | Description |
|---------|------|-------------|
| Icon Color |  | Choose a specific color for the toggle icon displayed on the right side. Select from your site’s color palette or click the eyedropper icon to find a new color. By default, toggle icons are a light gray. |
| Use Custom Icon Size |  | If you want to choose a specific size for the icon, toggle this option toyesand use the range slider to pick a size or type in a numerical value in the textbox. |
...
| Closed Title Text Shadow - |  | You can add a drop shadow to the closed title text. Once a style is selected, you can configure the direction of the shadow (horizontal and vertical), the strength of the drop shadow blur, and the shadow color. |
...
| Audio |  | ltmarginvalues for theAudiomodule are0. |
| Audio |  | ltpaddingvalues for theAudiomodule are as0: |
