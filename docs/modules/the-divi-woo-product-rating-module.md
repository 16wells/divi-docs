---
title: "The Divi Woo Product Rating Module"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/8676113-the-divi-woo-product-rating-module"
---
...
For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/8676113-the-divi-woo-product-rating-module).
...
| Woo Product Rating |  | oduct Ratingmodule to add it to your page. |
...
| Show Star Rating |  | Toggle this optiononoroffto show or hide the star rating. |
| Show Customer Reviews Count |  | Toggle this option toonoroffto show or hide the review count. |
...
| Centered |  | Select this option if you want the star rating and review number to be centered and stacked vertically. |
...
| Star Rating Letter Spacing |  | Choose the letter spacing of the start rating text by dragging the range slider or by typing in a numerical value. Letter spacing is the space between each star icon. The higher the number, the more space. |
