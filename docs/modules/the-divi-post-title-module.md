---
title: "The Divi Post Title Module"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/8645331-the-divi-post-title-module"
---
...
For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/8645331-the-divi-post-title-module).
...
|---------|------|-------------|
| WordPress Dashboard → Divi → Theme Builder |  | ilder.This brings you to the Theme Builder dashboard, where all the custom templates for your website live. |
| Add New Template |  | plate. |
| Posts |  | l to thePostssection and clickAll Posts. This will ensure that the design we create for blog posts will apply to all posts. Additionally, you can create unique page templates for posts in certain categories and tags and individual posts. |
| Create Template |  | reate Templatebutton at the bottom of the options window. This will create a blank page template with your global header and global footer automatically applied. |
| Add Custom Body |  | Body |
| Build Custom Body |  | Body |
| + |  | lick on the gray+icon to load the module library. |
| Post Title |  | n toPost Titleand click to load the module. |

### Content Tab

| Setting | Type | Description |
|---------|------|-------------|
| Show Title |  | Toggle this option toyesornoto show or hide the title. |
| Show Meta |  | Toggle this option toyesornoto show or hide the meta text. The meta text is the text that displays the author's name, post date, post category, and post comment count. |
| Show Author |  | Toggle this option toyesornoto show or hide the author's name. |
| Show Date |  | Toggle this option toyesornoto show or hide the post date. |
...
| Show Post Categories |  | Toggle this option toyesornoto show or hide the post's category. |
| Show Comments Count |  | Toggle this option toyesornoto show or hide the post's comment count. |
| Show Featured Image |  | Toggle this option toyesornoto show or hide the featured image. |
| Featured Image Placement |  | Choose where you'd like the feature image to be - above the title, below the title, or as a background image underneath the title and meta text. |
...
| Use Text Background Color |  | You can apply a background color to the post title and meta text by toggling this option toyes. Select a color from the site palette or use the dropper icon on the left to search for a new color. |
...
| Force Fullwidth |  | Toggle this option toyesif you want to force the module and its contents to be full-width. This means the module's contents will fill the entire row width. |
