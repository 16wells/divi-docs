---
title: "The Divi Woo Product Information Module"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/8676114-the-divi-woo-product-information-module"
---
...
For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/8676114-the-divi-woo-product-information-module).
...
| Woo Product Information |  | Informationmodule to add it to your page. |

### Content Tab

| Setting | Type | Description |
|---------|------|-------------|
| Product |  | This setting allows you to specify which product you want the module to relate to when it displays product information. By default, it's set toThis Product. For our purposes, we'll leave this setting set toThis Productso that it dynamically displays the correct product information based on whatever product is being viewed. |
| Show Title |  | Toggle this optiononoroffto show or hide theAdditional Informationtitle text. |
...
| Text Font Style - |  | Choose the text font style:ItalicizedCapitalizedSmall CapitalsUnderlinedStrike-through |
| Text Alignment - |  | Choose the text alignment specifically to the text:LeftCenterRightJustify |
...
| Text Shadow - |  | Add a drop shadow to the text. Once a style is selected, you can configure the direction of the shadow (horizontal and vertical), the strength of the drop shadow blur, and the shadow color. |
| Text Alignment - |  | Choose how the text aligns:LeftCenterRightJustify |
| Text Color - |  | Set the overall text color to light or dark. |
...
| Attribute Font Style - |  | Choose the style of the attribute text font:ItalicizedCapitalizedSmall CapitalsUnderlinedStrike-through |
| Attribute Text Alignment - |  | Choose the text alignment specifically to the attribute text:LeftCenterRightJustify |
...
| Attribute Letter Spacing - |  | Choose the letter spacing of the attribute text by dragging the range slider or by typing in a numerical value. Letter spacing is the space between each letter. The higher the number, the more space. |
...
| Attribute Text Shadow - |  | Add a drop shadow to the attribute text. Once a style is selected, you can configure the direction of the shadow (horizontal and vertical), the strength of the drop shadow blur, and the shadow color. |
...
| Table Border Color |  | Choose the border's color. You can select a color from your default site color palette that is already displayed or click on the eyedropper icon to find a new color. |
...
| Table Row Margin |  | Set the table row's margins. Margins add space outside the element. |
| Table Row Rounded Corners |  | If you want round table row corners, type in a numerical value. The higher the number, the rounder the corners will be. The corner values are automatically linked (as seen by the highlighted blue chainlink in the middle); however, if you’d like to have different values for each corner, simply click the blue chainlink to unlink the values. If the values are automatically linked, they will always have the same value and update automatically if one value is changed. |
| Table Row Border Styles |  | Add a border to the table row. You can add a border to all sides of the table row or individual sides (top, right, bottom, and left). |
| Table Row Border Width |  | This is where you set the width of the border. For a thicker border, increase the number. The border width must be at least 1px to show. |
| Table Row Border Color |  | This is where you can pick the border's color. You can select a color from your default site color palette that is already displayed or click on the eyedropper icon to find a new color. |
| Table Row Border Style |  | Select what border style you’d like: solid, dashed, dotted, double, groove, ridge, inset, outset, or none. |
| Table Row Box Shadow |  | Choose the style of shadow you want to apply to the image. By default, no shadow is applied. |
...
| Table Cell Margin |  | Set the table cell's margins. Margins add space outside the element. |
...
| Table Cell Border Width |  | This is where you set the width of the border. For a thicker border, increase the number. The border width must be at least 1px to show. |
| Table Cell Border Color |  | Choose the border's color. You can select a color from your default site color palette that is already displayed or click on the eyedropper icon to find a new color. |
