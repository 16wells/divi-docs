---
title: "The Divi Woo Product Images Module"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/8676297-the-divi-woo-product-images-module"
---
...
For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/8676297-the-divi-woo-product-images-module).
...
| Show Featured Image |  | Toggle this optiononoroffto show or hide the product featured image. |
| Show Gallery Images |  | Toggle this optiononoroffto show or hide the product gallery images. |
| Show Sale Badge |  | Toggle this optiononoroffto show or hide the sale badge (which only displays if the product has a sale price specified in its listing). |
...
| Setting | Type | Description |
|---------|------|-------------|
| Force Fullwidth |  | When enabled, the image width will take up 100% of its container. |
...
| Sale Badge Text Alignment |  | Choose the text alignment specifically to the sale badge text:LeftCenterRightJustify |
...
| Sale Badge Border Color |  | Choose the border's color. You can select a color from your default site color palette that is already displayed or click on the eyedropper icon to find a new color. |
