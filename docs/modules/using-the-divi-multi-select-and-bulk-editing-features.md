---
title: "Using the Divi Multi-Select and Bulk Editing Features"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/8661801-using-the-divi-multi-select-and-bulk-editing-features"
---
...
For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/8661801-using-the-divi-multi-select-and-bulk-editing-features).
...
|---------|------|-------------|
| Copy modules |  | dules. |
| Paste Modules |  | nd selectPaste Modules. |
| Drag icon |  | ag icon |
