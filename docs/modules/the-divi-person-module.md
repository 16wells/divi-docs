---
title: "The Divi Person Module"
category: modules
tags: [modules]
related: []
divi_version: "5.x"
last_updated: 2026-09-07
source_url: "https://help.elegantthemes.com/en/articles/8643122-the-divi-person-module"
---
...
For detailed information, see the [official Elegant Themes documentation](https://help.elegantthemes.com/en/articles/8643122-the-divi-person-module).
...
| Person module |  | n moduleand click on it to load the module.The module library is also searchable. Type the module name you want in the search bar at the top. |

### Content Tab

| Setting | Type | Description |
|---------|------|-------------|
| Name - |  | Type of the name of the person here. |
| Position - |  | Type the position of the person here. |
| Facebook Profile URL - |  | Copy and paste the person’s Facebook URL here. If this is left empty, the icon will not appear. |
| Twitter Profile URL - |  | Copy and paste the person’s Twitter URL here. If this is left empty, the icon will not appear. |
| Google + Profile URL - |  | Copy and paste the person’s Google + Profile URL here. If this is left empty, the icon will not appear. |
| LinkedIn Profile URL - |  | Copy and paste the person’s LinkedIn Profile URL here. If this is left empty, the icon will not appear. |
| Body - |  | Type the person's bio here. If left empty, it will not appear. |
| placeholder |  | eplaceholderimage to bring up the WordPress media library |
| Select |  | a photo from your uploads or upload a new photo. |
...
| Setting | Type | Description |
|---------|------|-------------|
| Icon Color - |  | Select from your site’s color palette or click the eyedropper icon to find a new color for the social media icons in this module. |
| Icon Size - |  | By default, the size of the icon will be the same as the text size in the module. However, you can select a custom icon size by toggling this option toyesand choosing a font size by dragging the range slider or typing in a numerical value in the textbook. |
| Image Rounded Corners - |  | If you would like to round the corners of the person module image, type in a numerical value. The higher the number, the rounder the corners will be. The corner values are automatically linked (as seen by the highlighted blue chainlink in the middle); however, if you’d like to have different values for each corner, click the blue chainlink to unlink the values. If the values are automatically linked, they will always have the same value and update automatically if one value is changed. |
...
| Position Font - |  | Choose the font you want for the position text. The default font is automatically selected; however, you can choose a different font or upload a custom font by clicking the dropdown box. |
| Position Font Weight - |  | Click the dropdown to select the boldness of the position text font. |
| Position Font Style - |  | Choose the style of the position text font:ItalicizedCapitalizedSmall CapitalsUnderlinedStrike-through |
| Position Text Alignment - |  | Choose the text alignment specifically to the position text only:LeftCenterRightJustify |
| Position Text Color - |  | Choose a specific color for the position text. Select from your site’s color palette or click the eyedropper icon to find a new color. |
| Position Text Size - |  | Choose the font size of the position text by dragging the range slider or typing in a numerical value. |
| Position Letter Spacing - |  | Choose the letter spacing of the position text by dragging the range slider or by typing in a numerical value. Letter spacing is the space between each letter. The higher the number, the more space. |
| Position Line Height - |  | Choose the line height of the position text by dragging the range slider or by typing in a numerical value. The line height is the amount of space between each line of text. The higher the number, the more space. |
| Position Text Shadow - |  | Add a drop shadow to the position text. Once a style is selected, you can configure the direction of the shadow (horizontal and vertical), the strength of the drop shadow blur, and the shadow color. |
